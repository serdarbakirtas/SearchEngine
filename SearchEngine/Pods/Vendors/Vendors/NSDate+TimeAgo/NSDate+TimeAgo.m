...
#define NSDateTimeAgoLocalizedStrings(key) \
  NSLocalizedStringFromTableInBundle(key, @"NSDateTimeAgo", [NSBundle bundleWithPath:[[[NSBundle bundleForClass:[DummyClass class]] resourcePath] stringByAppendingString:@"/NSDate-TimeAgo.bundle"]], nil)
#endif
...
- (NSString*)timeAgoSimple {
  ...
  int value;
  //    [[[NSBundle bundleForClass:[DummyClass class]] resourcePath] stringByAppendingString:@"NSDate-TimeAgo.bundle"];
  if (deltaSeconds < 60) {
