...
open class WebViewController: UIViewController {
    open let didLoadSignal = Signal<WebViewController>()
    ...
    public final var urlRequest: URLRequest? {
        didSet {
            if let urlRequest = self.urlRequest, self.isViewLoaded {
    ...
    fileprivate final lazy var _webView: WKWebView = { [unowned self] in
    ...
    fileprivate final lazy var _progressBar: UIProgressView = { [unowned self] in
    ...
    open override func viewDidLoad() {
        ...
        if let barTranslucent = self.barTranslucent {
            navigationController!.navigationBar.isTranslucent = barTranslucent
        }
        ...
        didLoadSignal.fire(self)

        if presentingViewController?.presentedViewController != nil {
            navigationItem.leftBarButtonItem = UIBarButtonItem(
                barButtonSystemItem: .done,
                target: self,
                action: #selector(WebViewController.didTapDoneButton(_:))
            )
        }
    ...
    open override func viewDidLayoutSubviews() {
        ...
        activity.tintColor = UIColor.red
    ...
    internal final func didTapDoneButton(_: UIBarButtonItem) {
